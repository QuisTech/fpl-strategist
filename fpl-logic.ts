...
import { FPLPlayer, FPLTeam, FPLFixture, ScoredPlayer, RecommendationResponse, TransferRecommendation, ChipAdvice } from "./src/types";
...
// Note: Transfer and Chip logic moved to fpl-engine.ts for architectural isolation
